// ── 形象宣傳部 PUBLICITY ─────────────────────────────────────
// 結構完全比照 gen.tsx（行政部）。把下面的 intro／joinBlurb／heads／members 換成本部門的內容即可。
// ★ 服務清單已統一移到 servicesData.ts：部門頁輪播自動用 servicesByDept("ima") 撈。幹部照放 imports/members/。
import { memImg, type DeptData } from "./deptShared";
