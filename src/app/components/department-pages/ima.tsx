...
// 服務圖放 imports/services/IMG-ima/；幹部照放 imports/members/。
...
export const ima: DeptData = {
  ...
  services: [
    { name: "聯絡我們", slug: "contact", img: svcImg("contact"), href: "#/contact" },
    { name: "系服訂購", slug: "dept-shirt", img: svcImg("dept-shirt"), href: "#", open: false  },
  ],
  heads: [
