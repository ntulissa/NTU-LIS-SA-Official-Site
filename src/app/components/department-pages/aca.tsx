...
// 服務圖放 imports/services/IMG-aca/；幹部照放 imports/members/。
...
export const aca: DeptData = {
  ...
  services: [
    { name: "教科書代訂", slug: "textbook", img: svcImg("textbook"), href: "https://forms.gle/hRrdBgktdzDasGqr6" },
    { name: "系友講座", slug: "alumni-talk", img: svcImg("alumni-talk"), href: "#", open: false },
    { name: "杜鵑花節", slug: "azalea", img: svcImg("azalea"), href: "#", open: false },
  ],
  heads: [
