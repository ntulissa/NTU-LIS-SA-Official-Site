...
//   cls       會長系級（如 "B12"）。
//   img       會長照片路徑；留空字串 "" ＝顯示「照片待補」佔位框（見下方「照片怎麼放」）。
...
//
// ── 照片怎麼放 ─────────────────────────────────────────────
//   把照片放到 public/Presidents/ 資料夾，再在對應屆數的 img 直接填網站路徑。
//   例如：img: "/Presidents/53.png"
// ══════════════════════════════════════════════════════════════════════════
