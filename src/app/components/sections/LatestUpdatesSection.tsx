...
export default function LatestUpdatesSection() {
  return (
    <section id="news" className="bg-black px-5 sm:px-8 md:px-14 py-16 sm:py-20 md:py-24">
            ...
            <Reveal key={item.title} delay={i * 60}>
              <div className="rounded-2xl border border-white/10 p-5 sm:p-6 md:p-8 flex flex-col justify-between gap-5 sm:gap-6 hover:border-white/20 transition-colors duration-200" style={{ background: "rgba(255,255,255,0.04)", minHeight: "240px" }}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <a href="#" className="inline-flex items-center justify-center gap-2 bg-white text-black px-5 py-2 rounded-full text-sm hover:bg-white/90 transition-all duration-200 group w-fit" style={{ fontFamily: "'Noto Sans TC', sans-serif", fontWeight: 700, letterSpacing: "0.08em" }}>
                    閱讀全文
